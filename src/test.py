...
CONTENT_IMG_PATH = os.path.join('D:\workspace/python/neuralstyle/images', '01.jpg')
STYLE_IMG_PATH = os.path.join('D:\workspace/python/neuralstyle/images', 'candinsky.jpg')
IMG_SIZE = 400
